...
def princess_lives_here():
	...
	if eat_it == "eat it":
		...
		print "The Princess cackles and eats ther frogs. Yum!"
		return 'death'
		...
		print "Then she siles and cries and thankyou for saving her."
...
def gold_koi_pond():
	...
	if feed_it == "feed it":
		...
		print "You are the pooped out a week later."
		return 'death'
...
def bear_with_sword():
	...
	if give_it == "give it":
		...
		print '"There the hell did that come from?" You say.'
...
def big_iron_gate():
	...
	if open_it == 'open it':
		...
		print '"Who\'s laughting now!? Love this katana."'
		return 'death'
	else:
